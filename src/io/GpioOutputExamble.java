...
*/
public class GpioOutputExamble extends ObjectStoreClass2 {
    ...
    */
   public static void outGpio() throws InterruptedException{
   ...
   public static void setCeckBox(boolean state) {
	   
	   ObjectStoreClass2.checkbox[2].setSelected(state);
	   System.out.println("Ceck Box uno   " + ObjectStoreClass2.checkbox[2].isSelected()); 	   
   }
   
  public static void setJTextArea(boolean state) {
	   
	   ObjectStoreClass2.txta[4].setText("testo scritto nel gpio");	   
   }
}
